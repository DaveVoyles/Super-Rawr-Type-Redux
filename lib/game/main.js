...
window.RType = ig.Game.extend({
    ...
    setGame: function () {
        ...
        this.setMusic();          // Gets & starts game music
    ...
    //TODO: Move this to soundmanager
    setMusic: function () {
    ...
    createGameOverTimer: function(){
        ...
        if (this.gameOverTimer && this.gameOverTimer.delta() > 0) {
                this.setLosingEnd();  //TODO: Create a check for win / lose
                this.setGameOver();
