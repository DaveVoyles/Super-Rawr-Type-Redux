...
.defines(function () {
	...
	ig.merge(ig, window.ImpactMixin);
        ...
        function setupInputControls() {
            ...
            Bindings.changeAutoRepeat = function (newAR) {
                ig.input.bind(ig.KEY.C, Bindings.shoot, newAR);
            };
    ...
    window.RType = ig.Game.extend({
       ...
       //     this.setGame();                // DEBUG: Just launch right into the game, save time
        ...
        setGame: function () {
            ...
            ig.game.spawnEntity(EntityActorEnemyChomper, ig.system.width / 2, ig.system.height /2);
            this.setDifficulty();
            this.setUI();
        ...
        poolEntities: function () {
            ...
            EntityHomingMissile.setupPool          (30);
        },
