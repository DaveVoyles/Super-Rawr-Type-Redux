...
.defines(function () {
    ...
    window.RType = ig.Game.extend({
        ...
        init: function () {
            ...
            // fill the engine
            this.starSparkle.spawn(starCount);
        ...
        gameOver: function () {
            ...
            EntityPickupBulletTime.prototype.currentBulletTime = 4;
        },
        setVictoryEnd: function () {
            this.clearMusic.play();

            gameOverTimer = new ig.Timer(20);
            if (this.gameOver.delta() > 0){
                this.gameOver();
            }
        },
        toggleMenu: function () {
        ...
        setGame: function () {
            ...
            this.menu         = null;
            this.player       = ig.game.spawnEntity(EntityActorPlayer, ig.system.width / 3, ig.system.height / 2);
        ...
        getBoss: function () {
            if (ig.game.boss){
                ig.music.crossFade(1, 'bossMusic');
            }
        },
