...
window.RType = ig.Game.extend({
    ...
    clearScreen: function(){
        // Safeguard, in case player has many lives left. Guarantees that they will be removed from screen
        ig.game.lives = 0;
       // if (this.player) { ig.game.removeEntity(this.player); };
        ...
        ig.game.entites =[];    // Clear ann entities off screen
        this.poolEntities();    // Pool entities again, needed for performance
