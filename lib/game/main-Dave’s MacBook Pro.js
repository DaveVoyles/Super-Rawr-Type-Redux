...
function setupInputControls() {
    ...
    window.RType = ig.Game.extend({
        ...
        createPathAndFollower: function(){
            ...
            var myPath    = new ga.Path ( [ig.system.width, ig.system.height /2, ig.system.width /2 , 5] ) ;
            settings.path = myPath;
            myPath.addFunctionPath( 100, 200, function(r) { return 50*Math.sin(2*Math.PI*r);} , 5 );
