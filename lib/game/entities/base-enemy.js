 ...
 *  @desc:      Abstract base actor for all enemy ships
 ***********************************************************************/
ig.module(
...
.defines(function () {
  //  EntityBaseEnemy = ig.Entity.extend({
    EntityBaseEnemy = EntityFollower.extend({
        ...
        lootDrop: function () {
            var rndNum = this.randomFromTo(1, ig.game.chanceToSpawnPickups.max);
            //TODO: Need to fix this. Numbers are off.
            if (rndNum > ig.game.chanceToSpawnPickups.min ) {
            ...
            switch (rndDropNum) {
                ...
                case 4:
                    if (ig.game.missiles.current < ig.game.missiles.max) {
                        ig.game.spawnEntity(EntityObjectPickupMissile,     this.pos.x, this.pos.y);
                    }
                    break;
                default:
                    break
        ...
        spawnParticlesOnDeath: function(){
