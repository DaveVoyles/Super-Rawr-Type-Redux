...
.defines(function () {
    ...
    ******************************************/
    ...
    soundShoot:        new ig.Sound('media/sfx/hit01.ogg'                                 ),
    ...
    ******************************************/
    init: function (x, y, settings) {
        ...
        this.EnemySpawner        = ig.game.spawnEntity(EntityActorEnemySpawner, this.pos.x + 400, null);
    ...
    ******************************************/
    ...
    /*******************************************
    * draw_pu_BU_Text
    * Draws text for when BT is picked up 
    ******************************************/
    ...
    ******************************************/
    onDeath: function () {
        ...
        if (ig.game.stats.lives === 0) {
            // TODO: spawn game ending logic here
        } else {
            ig.game.spawnEntity(EntityActorPlayer, ig.game.playerPosAtDeath.x, ig.game.playerPosAtDeath.y);
