...
ig.module(
	...
	window.FragmentSpawner = ig.Class.extend({
     	...
     	init : function(maxParticleCount) {
     		...
     		this._jSparkle = new ga.JSparkle(Fragment, maxParticleCount, getGameTime );
     	},
     	 ...
     	 * _count is optionnal, default to defaultCount (==10)
     	 * *************************************************************************************/
     	...
     	update : function() {
     		this._jSparkle.update();
     	}, 
     	draw : function() {
     		this._jSparkle.draw(ig.system.context);
     	}
     });
        ...
        __screenY : 0,
     	...
     	update : function() {
     	 ...
     	 draw : function() {
                ...
                this.drawContext.drawImage(this.image, getDrawPos(this.x - this.__screenX ), getDrawPos(this.y - this.__screenY));
     	 },
     	 preDraw : function() { 
