...
.defines(function () {
    ...
    ig.Game = ig.Class.extend({
        ...
        // # of slowMo items player has in inventory
        bulletTime:{
            current: 4,
            max:     4
        },
        ...
        // # of enemies which can be on screen at a time
        enemies:{
            current:0,
            max:    5    
        },
        // Player's inventory of missiles
        missiles:{
            current:10,
            max:    10
        },
        // Determines how quickly enemeis should spawn, based on difficulty
        spawnTime:{
            min:   2,
            max:   7
        },
        // What chance does the player have that the enemy will spawn a pickup, upon their death
        chanceToSpawnPickups:{
            min:   1,
            max:   5
        },
        // Resets default values after each game, based on selected difficulty
        resetStats: function(difficulty) {
            switch (difficulty){
                case 'EASY':

                        this.stats.kills 		      = 0;
                        this.stats.lives 		      = 4;
                        this.stats.maxLives 	      = 4;
                        this.bulletTime.current       = 4;
                        this.bulletTime.max 	      = 4;
                        this.companions.current       = 0;
                        this.companions.max       	  = 2;
                        this.turrets.current 	      = 8;
                        this.turrets.max	          = 8;
                        this.enemies.current 	      = 0;
                        this.enemies.max 	       	  = 4;
                        this.bossSpawnKills           = 2;
                        this.missiles.current         = 20;
                        this.missiles.max             = 20;
                        this.spawnTime.min            = 3;
                        this.spawnTime.max            = 7;
                        this.chanceToSpawnPickups.min = 1;
                        this.chanceToSpawnPickups.max = 2
                        break;
                ...
                case 'NORMAL':
                        ...
                        this.companions.current       = 0;
                        this.companions.max 	      = 2;
                        this.turrets.current 	      = 4;
                        this.turrets.max	          = 5;
                        this.enemies.current 	      = 0;
                        this.enemies.max 	          = 5;
                        this.bossSpawnKills           = 20;
                        this.missiles.current         = 15;
                        this.missiles.max             = 15;
                        this.spawnTime.min            = 2;
                        this.spawnTime.max            = 5;
                        this.chanceToSpawnPickups.min = 1;
                        this.chanceToSpawnPickups.max = 3
                        break;
                ...
                case 'HARD':
                        ...
                        this.bulletTime.max 	      = 4;
                        this.companions.current       = 0;
                        this.companions.max           = 3;
                        this.turrets.current 	      = 4;
                        this.turrets.max	          = 4;
                        this.enemies.current 	      = 0;
                        this.enemies.max 	          = 8;
                        this.bossSpawnKills           = 40;
                        this.missiles.current         = 10;
                        this.missiles.max             = 10;
                        this.spawnTime.min            = 1;
                        this.spawnTime.max            = 3;
                        this.chanceToSpawnPickups.min = 1;
                        this.chanceToSpawnPickups.max = 3
                        break;
            }
